...
public class PaymentServiceImpl implements PaymentService {
    ...
    public Payment addPayment(Order order, String method, Map<String, String> data) {
        ...
        if (method.equals(PaymentMethod.COD.getValue())) {
            payment = createCashOnDeliveryPayment(order, method, data);
    ...
    public Payment createCashOnDeliveryPayment(Order order, String method, Map<String, String> data) {
